...
class HAPPY:
    ...
    from .gui_page import setup_ui, load_font, configure_styles, setup_button, setup_tree_input, setup_encode_buttons, setup_output_tree, setup_progressbar, setup_checkboxes, setup_dropdown, update_progress_text, console_log_progress, ask_overwrite_confirmation
    ...
    from .encode_page import on_encode_click, send_to_encoder, encoder_worker, run_encoder, check_for_overwrite